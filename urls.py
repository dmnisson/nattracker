...
from .views import ProfileView, SituationView, ResponseView, AddSituationView, EditSituationView
from .views import AddResponseView, EditResponseView, DeleteResponseView, StatisticsView
...
urlpatterns = [
    ...
    path('users/response/<int:pk>', ResponseView.as_view(), name='response_detail'),
    ...
    path('users/response/add/<path:success_path>', AddResponseView.as_view(), name='add_response'),
    path('users/response/edit/<int:pk>', EditResponseView.as_view(), name='edit_response'),
    path('users/response/edit/<int:pk>/<path:success_path>', EditResponseView.as_view(), name='edit_response'),
    path('users/response/delete/<int:pk>', DeleteResponseView.as_view(), name='delete_response'),
